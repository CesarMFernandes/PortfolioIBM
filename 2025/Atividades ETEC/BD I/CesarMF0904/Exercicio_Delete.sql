...
--Tabela categoria
select * from Categoria where Descricao like 'Queijo';
delete from Categoria where Descricao like 'Queijo';

select * from Categoria where Descricao like 's%';
delete from Categoria where Descricao like 's%';

select * from Categoria where Nome_Categoria like '%a%';
...
select * from Envio where NomeNavio like  'Chop-suey Chinese';
delete from Envio where NomeNavio like  'Chop-suey Chinese';

select * from Envio where Frete > 100;
delete from Envio where Frete > 100;

--tabela território
select * from Territorio where Cod_Regiao = 3;
delete from Territorio where Cod_Regiao = 3;

select * from Territorio where Territoriodescricao like 'New York';
delete from Territorio where Territoriodescricao like 'New York';

select * from Territorio where Cod_Territorio > 90000;
