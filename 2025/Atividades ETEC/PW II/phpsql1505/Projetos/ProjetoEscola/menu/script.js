...
function cadastrar(){
    if(tit.textContent != "Cadastrar"){
        ...
        setTimeout(function(){
            ...
            dis.href = "../AcessoBD/disciplinas/Cadastrar.php";
...
function excluir(){
    if(tit.textContent != "Excluir"){
        ...
        setTimeout(function(){
            ...
            dis.href = "../AcessoBD/disciplinas/Excluir.php";
...
function pesquisar(){
    if(tit.textContent != "Pesquisar"){
        ...
        setTimeout(function(){
            ...
            dis.href = "../AcessoBD/disciplinas/Pesquisar.php";
...
function listar(){
    if(tit.textContent != "Listar"){
        ...
        setTimeout(function(){
            ...
            dis.href = "../AcessoBD/disciplinas/Listar.php";
...
function alterar(){
    if(tit.textContent != "Alterar"){
        ...
        setTimeout(function(){
            ...
            dis.href = "../AcessoBD/disciplinas/Alterar.php";
            cur.href = "../AcessoBD/cursos/Alterar.php";
            alu.href = "../AcessoBD/alunos/Alterar.php";
            form.classList.remove("conteudoh");
            form.classList.add("conteudo");
        }, 500);
        bcadastrar.classList.remove("selected");
